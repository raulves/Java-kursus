...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ClientBuilder client2 = new ClientBuilder("Anni")
                .setAge(30)
                .setHasDiscount(false);
        ClientBuilder client3 = new ClientBuilder("Reino")
                .setAge(27)
                .setHasDiscount(true)
        ...
        gym.addClients(client1);
        gym.addClients(client2);
        gym.addClients(client3);
